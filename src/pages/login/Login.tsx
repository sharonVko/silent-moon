  ...
  return (
    <>
      ...
      <div className="mt-10 mb-10 text-center">
        ...
        <p className="sans-pro-600 f-s-16 grey p-2">
      ...
      <div className="text-center p-5 ">
        <Link to="/signup">
          <button className="btn-pink f-s-16">Sign Up</button>
        </Link>
        <p className="mt-2 sans-pro-600 grey f-s-16 ">
          ALREADY HAVE AN ACCOUNT?{' '}
          <Link className="pink" to="/signin">
            LOG IN
          </Link>
        </p>
      </div>
