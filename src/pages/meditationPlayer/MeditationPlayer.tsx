...
import { FavoriteGrossIconBtn } from '../../assets/svg/FavoriteGrossIconBtn';
      ...
      <div className="audioplayer flex flex-col items-center bg-transparent p-4 rounded z-20 max-w-lg mx-auto ">
        <div className="flex items-center gap-10 pb-4">
          ...
          <button onClick={handlePlayAndPause}>
            <img
              src={isPlaying ? '/img/pause-btn-olive.png' : '/svg/play-btn-olive.svg'}
              alt="Play/Pause"
              className="w-20 h-20 "
            />
          </button>
        ...
        <audio ref={audioRef} src={music?.track_url} onTimeUpdate={handleTimeUpdate}></audio>
      </div>
    </div>
  );
};
