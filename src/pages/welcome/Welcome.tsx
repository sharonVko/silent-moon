...
export const Welcome = () => {
  return (
    <div className=" mx-auto">
      ...
      <p className="light-cream text-3xl/normal tracking-wider font-extrabold pl-8 pt-2 absolute top-24 left-1">
        Hi USER , <br /> welcome <br />
        to Silent <br /> Moon
      </p>
      <Link to={'/home'} className="btn-pink absolute bottom-18 left-8">
        GET STARTED
      </Link>
    </div>
  );
